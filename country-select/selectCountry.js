...
function initPage() {
    ...
    $('.J-catalogPop').on('click','.J-country-add', function(e) {
        ...
        getCountryList(function(json) {
            ...
            countryDialog = art.dialog({
                ...
                ok : function() {
                    ...
                    var $countryBox = $('.J-catAuthority-country');
                    ...
                    for (region in regions) {
                        ...
                        for (country in countries) {
                            if (countries[country]['myChecked']) {
                                ...
                                $countryBox.find('.J-country-add').before(html);
...
function viewCountryListmm(json,selected){
    var _container = '<div class="form select-country">',
        _content = '<div class="country-content colspan4 J-lists flags">',
        _tab = '<div class="tab-primary J-tab">',
        _sel = selected,
...
// 删除
$('.J-catalogPop').on('click','.J-catAuthority-country .del',function(e){
    e.preventDefault();
    var $target = $(e.target);
